...
import { EVENT_ID } from 'src/constants'
...
export const describe = (storyName: string, func: () => void) => {
...
export const it = function (desc: string, func: () => void) {
